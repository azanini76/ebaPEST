...
!     -- types
      ...
      type  :: d_algorithmic    ! ALGORITHMIC "GLOBALS"
            ...
            double precision, pointer  :: Hsprior(:)
      ...
      type  :: d_prior_mean     ! data for prior means - pointer
            ...
            double precision,pointer    ::  limits(:,:)      !MD Upper and lower limits of bounded transformation
            integer, pointer            ::  Partrans(:)    !MD Vector of parameter transformation [0] None [1] Log [2] Power [3] Bounded
      ...
      type  :: cv_struct        ! CONTROL VARIABLES FOR STRUCTURAL PARAMETERS
            ...
            integer, pointer		    ::	var_type(:)  !MD Type of variogram [0] pure nugget, [1] linear, [2] exponential, [3] gaussian, [4] spherical
      ...
      type  :: d_param           ! data type for parameters
            ...
            double precision, pointer       :: prior(:)      !MD Prior parameters
      ...
      type  :: d_observ           ! data type for observations
            ...
            double precision, pointer   :: linobs(:)   !MD Vector of linearized observations
            double precision, pointer   :: misfit(:)   !MD Vector of misfits
