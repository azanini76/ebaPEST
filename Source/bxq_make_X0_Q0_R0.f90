...
subroutine bxq_make_X_Q0_R0(d_PAR,cv_S,d_S,cv_PAR,d_XQR,cv_A,d_OBS,nobs,Q0_All,cv_PM,d_PM,d_ANI)     
...
40                    format('Error: Beta association value ',i6, ' corresponds to different parameter types.' &
             ...
             d_PM%beta_0(d_PAR%BetaAssoc(i))=d_PM%beta_0(d_PAR%BetaAssoc(i))+1
             enddo
...
end subroutine bxq_make_X_Q0_R0
